    ...
    return (
        <MDBCard >
            <MDBCardHeader className="view view-cascade gradient-card-header blue-gradient d-flex justify-content-between align-items-center py-2 mx-4 mb-3">
                <h1><a className="white-text mx-1">TEC Market</a></h1>
            </MDBCardHeader>
    ...
    render() {
        const mystyle ={
            ...
            <main style = {{marginLeft:"120px"}}>
                ...
                <Route path="/reports/sucursales" component={Hello} />
                <Route path="/reports/historial" component={Hello} />
                <Route path="/reports/top5" component={Hello} />
            </main>
        </React.Fragment>
        ) } />
        </Router>
